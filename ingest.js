...
fs.createReadStream(`./matches/18xx/2010-Chattanooga/18xx2010.csv`)
  .pipe(csv())
  .on('data', (data) => {
    ...
    const dat = {
      ...
      createdAt,
      updatedAt,
      event: 'Chattanooga Rail Gaming Challenge 2010 18xx Grand Prix',
    ...
    fs.writeFileSync(
      `matches/18xx/2010-Chattanooga/${data.id}.json`,
      JSON.stringify(dat)
    )
  })
  .on('finish', () => {
